    ...
    return (
        ...
        <div className="mt-5 ml-10 mr-10" >
            ...
            <div className="flex justify-evenly mt-6">
                <input onChange={(e)=>setName(e.target.value)} className="border-2 border-black rounded-md p-1" type="text" placeholder="Your Name" />
                <input onChange={(e)=>setPhone(e.target.value.toString())} className="border-2 border-black rounded-md p-1" type="number" placeholder="Your Number" />
                <input onChange={(e)=>setEmail(e.target.value)} className="border-2 border-black rounded-md p-1" type="email" placeholder="Your Email" />
                <input onChange={(e)=>setGithub(e.target.value)} className="border-2 border-black rounded-md p-1" type="text" placeholder="Your Github" />
            </div>
